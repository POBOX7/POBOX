...
class TrendingProductController extends Controller 
{
     ...
     */
    public function trendingProductIndex()
    {
        $productList = DB::table('products')
                            ...
                            ->orderByDesc('id')
                            ->get();
        return view('admin.trending_products.product_index')->with('productList', $productList); 
    }

    public function addProductTrending( Request $request ) {
    	...
    	return view('admin.trending_products.product_add')->with('categoryList', $categoryList)->with('brandList', $brandList)->with('colorList', $colorList)->with('sizeList', $sizeList);
    }

    public function bulkUploadTrending( Request $request ) {
        return view('admin.trending_products.product_csv_import');
    }

    public function storeBulkUploadTrending( Request $request ) {    
        ...
        return redirect()->route('trendingProductIndex')->with('success', 'Product created successfully.');
     ...
     * @return \Illuminate\Contracts\Support\Renderable
     */
    public function storeProductTrending( Request $request ) {    
        $validatedData = $request->validate([
       ...
       $image_resize->resize(277, 400);
        ...
        return redirect()->route('trendingProductIndex')->with('success', 'Product added successfully.');
        
    }

    public function editProductTrending(Request $request ,$id)
    {
        $id = base64_decode($id);
        ...
        return view('admin.trending_products.product_edit',compact('productDetail','id','categoryList','brandList','colorList','sizeList'));
    }

    public function viewProductTrending(Request $request ,$id)
    {
        $id = base64_decode($id);
        ...
        return view('admin.trending_products.product_view',compact('productDetail','id','sizeList'));
    }

    public function printProductTrending($id)
    {
        $id = base64_decode($id);
    ...
    public function updateProductTrending(Request $request ,$id)
    {
        $request->validate([
       ...
       if (isset($request->image)) {
        ...
        return redirect()->route('trendingProductIndex')->with('success', 'Product details updated successfully.');
    }

    public function productDestroyTrending($id)
    {
        $update_data = array(
                                'is_deleted' => 1,
                                'updated_at'    => date('Y-m-d H:i:s')
        ...
        ->update($update_data);
        return redirect()->route('trendingProductIndex')->with('success', 'Product removed successfully.');
    }

    public function productStatusTrending()
    {
        extract($_POST);
    ...
    public function productImageDestroyTrending($id)
    {
        ProductImage::where('id',$id)->delete();
        echo '1';
    }

    public function allProductTrending()
    {
    ...
    public function allSizeTrending()
    {
    ...
    public function exportTrending(Request $request) 
    {
