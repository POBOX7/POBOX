                ...
                <div class="panel-body" style="border: 1px solid rgb(141, 153, 174);">
							...
							<input name="address_selection" type="radio" value="old" checked="true" /><label>Choose from existing addresses.</label><br>
								...
								<select type="text" name="address" id="address_old"  class="choose_address form-control " > <!-- disabled -->
									...
									@foreach($addresses as $keye => $value)
									  <option class="tick_shipping" value="{{$value->id}}" address-value='' name="{{$value->name}}" phone_number="{{$value->phone_number}}" pincode="{{$value->pincode}}"  address_line_one="{{$value->address_line_one}}" address_line_two="{{$value->address_line_two}}" address_line_three="{{$value->address_line_three}}" city="{{$value->city}}" state="{{$value->state}}" >{{$value->name .' - '. $value->address_line_one.', '.$value->address_line_two.', '.$value->address_line_three.', '.$value->pincode.', '.$value->city.', '.$value->state }}</option> 
									@endforeach
								</select>   
                    ...
                    <div class="col-md-12">
                      <label for="first_name">Full Name<span class="redColor">*</span></label>
			            <!-- onKeyPress = "return ValidateAlpha(event)" oninvalid="setCustomValidity('Please enter on alphabets only. ')" pattern="[a-zA-Z]*" --> 
	                     <input type="text" name="name" id="name" type="text" class="address_name form-control"  required="required" {{Auth::check()? "disabled":""}}>
						 <span class="text-danger" class="error"></span>
                    </div>

                      <div class="col-md-12">
                      <label for="address1">Phone no<span class="redColor">*</span></label>
                      <input type="number" name="phone_number" id="phone_number"  maxlength="10" class="address_address form-control" required="required" {{Auth::check()? "disabled":""}}>
					  <span class="text-danger" class="error"></span>
					</div>
					...
					@if(!Auth::check())
				     ...
				     <div class="col-md-12">
                      ...
                      <input type="text" name="email" id="email" value="" class="address_address form-control" required="required" >
						<span class="text-danger" class="error"></span>				
				</div>
					...
					@endif	
                     ...
                     <div class="col-md-12">
                      ...
                      <input type="text" name="address_line_two" id="address_line_two" type="text" maxlength="30" class="address_address form-control" required="required" {{Auth::check()? "disabled":""}}>
					  <span class="text-danger" class="error"></span>                   
				   </div>
                   
                    <div class="col-md-12">
                      <label for="address1">Landmark<span class="redColor">*</span> </label>
                      <input type="text" name="address_line_three" id="address_line_three" type="text" maxlength="30" class="address_address form-control" {{Auth::check()? "disabled":""}}>
					 <span class="text-danger" class="error"></span>                   
				   </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" name="state" id="state" type="text" class="address_address form-control" maxlength="30" {{Auth::check()? "disabled":""}}>
						 <span class="text-danger" class="error"></span> 
					</div>
        ...
        <div class="panel panel-default ">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" style="width: 100%">
                <div class="panel-body" style="border: 1px solid rgb(141, 153, 174);">
                    ...
                    <div class="col-md-12">
                      <label for="first_name">Full Name<span class="redColor">*</span></label>
			<!--onKeyPress = "return ValidateAlpha(event)"  pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter on alphabets only. ')" -->
                      <input type="text" name="billing_name" id="billing_name" type="text" class="address_name form-control" >
                    	<span class="text-danger" class="error"></span>      
					</div>

                      <div class="col-md-12">
                      <label for="address1">Phone no<span class="redColor">*</span></label>
                      <input type="number" name="billing_phone_number" id="billing_phone_number"  type="text" class="address_address form-control" required="required">
                    	<span class="text-danger" class="error"></span>      
					</div>

                    <div class="col-md-12">
                      <label for="address1">Pin code<span class="redColor">*</span></label>
                      <input type="number" name="billing_pincode" id="billing_pincode" type="text" class="address_address form-control" required="required">
                    	<span class="text-danger" class="error"></span>      
					</div>
                                ...
                                <div class="collapse show" id="order-cart-section" style="">
                                    <table class="table table-mini-cart">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="price-col">₹{{$value->qty * $value->price}}<br/><strike>₹{{$value->mrp}}</strike></td>
                                            </tr>
                                              @php
                                               $Subtotal += ($value->qty * $value->mrp);
											   $GST = $GST + $value->gst;
											   $discount = $discount + ($value->mrp - $value->price) ;
                                              @endphp
                                            @endforeach
                                    ...
                                    <tbody>
                                        <tr>
                                         ...
                                         <tr>
                                            <td>You Saved</td>
                                            <td style="text-align: right!important;">₹{{$discount}}</td>
                                        </tr>
										 <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right!important;">₹{{$GST}}</td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <input type="hidden" name="totalamount" value="{{($Subtotal - $discount) + $GST}}" id="ordertotal"/>
                                            <input type="hidden" name="paymentid" value="" id="paymentid"/>
											<td>₹{{($Subtotal - $discount) + $GST}}</td>
                                        </tr>
                                    </tfoot>
                                </table>
