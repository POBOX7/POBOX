<aside class="sidebar-shop col-lg-3 order-sm-first">
   <div class="visible-md view-on-mobile filter-button">
      <p>
   ...
   <div class="sidebar-wrapper" style="position: absolute!important;" id="sidebarabsolute">
      <div class="widget">
         <h3 class="widget-title">
            <div class="row">
               ...
               <div class="col">
                  <a href="#" class="clearall" id="clearall" style="float: right;color: red;width: 90px;">Clear All</a>
               </div>
            </div>
         </h3>
      </div>
      ...
      <div class="widget">
         ...
         <div class="collapse show" id="widget-body-2">
            <div class="widget-body">
               <div class="container" id="clearall_filter">
                  <div class="row">
                     <div class="col-sm-12">
               ...
               <!-- <form action="#">
                  <div class="price-slider-wrapper" data-min="100">
                     <div id="price-slider" onchange="myFunction()"></div>
                    
                  </div>
                  
                  <div class="filter-price-action">
                     <button type="submit" class="btn btn-primary" onclick="myFunction()">Apply</button>
      ...
      <div class="widget">
         ...
         <div class="collapse show" id="widget-body-6">
            <div class="widget-body">
               <ul class="config-swatch-list color" >
      ...
      <div class="widget">
         ...
         <div class="collapse show" id="widget-body-3">
            <div class="widget-body">
               <ul class="config-size-list size">
               ...
               <div><a  data-toggle="modal" data-target="#myModal_size" style="cursor: pointer;font-size: 14px!important;color: #1a62ad;">Size Guide</a>  </div>
            ...
            <!-- <div class="owl-carousel widget-featured-products"> -->
               <div class="featured-col">
                  ...
                  <div class="product-default left-details product-widget">
                     <figure>
                        <a href="{{route('productDetail',$valueFeaturedProduct['id'])}}">
                        <img src="{{ asset('assets/upload_images/product') }}/{{$valueFeaturedProduct['image']}}">
                        </a>
                     </figure>
                     <div class="product-details">
                        <h2 class="product-title">
                           <a href="{{route('productDetail',$valueFeaturedProduct['id'])}}" style="color: black!important;">{{$valueFeaturedProduct['name']}}</a>
                        </h2>
...
<script type = "text/javascript" >
  var productcount = <?php echo json_encode(count($newArrivalProductDatas)) ?>; 
   ...
   var page_url = null;
    if(window.location.href.indexOf("trending") > -1){ 
        var page_url = "Trending"; 
      }
      if(window.location.href.indexOf("new-arrival") > -1){ 
        var page_url = "new-arrival"; 
      }
      if(window.location.href.indexOf("kurties") > -1){ 
        var page_url = "kurties";  
         $('#categories').hide(); 
      }
      ...
      if(window.location.href.indexOf("dresses") > -1){ 
        var page_url = "dresses"; 
        $('#categories').hide();
      }
    ...
    $(".filter-button p").click(function(){
     ...
     $('li.size a').on('click', function (e) {
     e.preventDefault(); 
     var size_id = $(this).parent().attr('id');  
     var clearall = [];  
     $('li.size a').removeClass('active');
     ...
     /*CATGORIES FILTER*/
     $('li.categories a').on('click', function (e) {
     e.preventDefault();
     var clearall = [];
     
     $('li.categories a').removeClass('active');
     $(this).addClass('active');  
     var categories_id = $(this).parent().attr('id');  
         categories.push(categories_id);
     ...
     //Brand Filter
     $('li.brand a').on('click', function (e) {
     $('li.brand a').removeClass('active');
     $(this).addClass('active'); 
     e.preventDefault();
     var clearall = [];
     ...
     /*color filter*/
     $('li.color a').on('click', function (e) {
     ...
     if ( $.inArray(color_id, color) > -1 ) { 
         color = $.grep(color, function(value) {
             return value != color_id;
        }); 
     }else{  
       color.push(color_id);   
     } 
     ...
     function myFunction() { 
     // alert(document.getElementsByName('min-value').value);
     ...
     /*empty array*/
     $('li.size a').removeClass('active');
     $('li.color a').parent().removeClass('active');
     $('li.brand a').removeClass('active');
     $('select.sorting option#Default').attr("selected", "selected");
     ...
     $('li.categories a').removeClass('active'); 
       ...
       min_price.splice(0, min_price.length); 
       max_price.splice(0, max_price.length); 
    ...
    if(window.location.href.indexOf("trending") > -1){ 
     ...
     document.getElementsByName('max-value').value = moneyFormat.from(
       values[1]);
     //alert(document.getElementsByName('min-value').value);
     // alert(document.getElementsByName('max-value').value);
     var clearall = [];
     minprice = document.getElementsByName('min-value').value;
     maxprice = document.getElementsByName('max-value').value;
     min_price.push(minprice);
     if (min_price.length > 1) {
         min_price.splice(0, 1);
     }
...
<style type="text/css">
.widget.widget-featured .product-widget {
    height: 76px;
    width: 100%;
}
.widget.widget-featured .product-widget .product-details{
  min-width: 66%;
}
.addcart {
    text-transform: uppercase!important;
}
.widget.widget-featured .product-widget .product-title {
