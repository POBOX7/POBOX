...
<table class="maintable" style="border: 0px !important;width: 100%;">
    <tr style="text-align: center!important;">
        ...
        <td style="width: 55%;">
          ...
          <p style="font-size: 20px;">Order number {{$OderDatas['ordernumber']}} is Delivered :PO Box</p>
          <p>Hi Dear {{$oderData[$keyOderData]['address_data']['name']}},</p>
          <p>This is a follow up email to know you that your recent order has been shipped to your provided address.</p>
          <p>Your order number {{$OderDatas['ordernumber']}} has been delivered to your provided shipping address. Let us know if you have any questions.</p>
         <p>Thank you for shopping with us. We hope you enjoy shopping experience with us.</p>
