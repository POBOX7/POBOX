...
<table class="maintable" style="border: 0px !important;width: 100%;">
    <tr style="text-align: center!important;">
        ...
        <td style="width: 55%;">
          ...
          <p style="font-size: 20px;">Order number {{$OderDatas['ordernumber']}} is dispatched :PO Box</p>
          <p>Dear {{$oderData[$keyOderData]['address_data']['name']}},</p>
          <p>We are happy to to let you know that following item(s) of your order number {{$OderDatas['ordernumber']}} have been shipped.</p>
