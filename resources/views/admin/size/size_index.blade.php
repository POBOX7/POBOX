                        ...
                        @if(count($sizes))
                          @foreach($sizes as $key => $size)
                            <tr>
                                ...
                                <td>
                                  <a href="{{route('edit.size',base64_encode($size->id) )}}"><i class="ti-pencil-alt" style="font-size: 2rem;"></i></a>
                                  <a onclick="showSwal({{$size->id}})"><i class="ti-trash" style="font-size: 2rem;color: #007bfe;"></i></a>
                                </td>
                            </tr>
                          @endforeach
                        @else 
