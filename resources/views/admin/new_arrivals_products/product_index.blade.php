...
<div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-3">
                  <h4 class="card-title">NEW ARRIVAL PRODUCTS</h4>
                </div>
                <div class="col-md-9" style="text-align: right">

                  <form class="forms-sample" action="{{route('export.product.newarrivals')}}" method="GET" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="row mobile-view-date-filter">
                    ...
                    <div class="col-md-4" style="text-align: right">
                      ...
                      <!-- <a href="{{route('add.product.newarrivals')}}"   class="btn btn-success">Add New</a> -->
                    </div>
                  </div>
                  </form>
                </div>
                          ...
                          @foreach($productList as $key => $product)
                            <tr>
                                ...
                                <td style="width: 180px;">
                                  {{-- <a href="{{route('edit.product.newarrivals',base64_encode($product->id) )}}" class="btn btn-outline-primary">Edit</a> --}}
                                  <a href="{{route('edit.product.newarrivals',base64_encode($product->id) )}}" data-toggle="tooltip" title="Edit"><i class="ti-pencil-alt" style="font-size: 2rem;"></i></a>
                                  ...
                                  <a href="{{route('view.product.newarrivals',base64_encode($product->id) )}}"><i class="ti-eye" style="font-size: 2rem;" data-toggle="tooltip" title="View"></i></a>
                                  @if($product->barcode !== null )
                                  <a href="{{route('print.product.newarrivals',base64_encode($product->id) )}}" target="_blank" data-toggle="tooltip" title="Print"><i class="ti-printer" style="font-size: 2rem;"></i></a>
                                  @endif
                                </td>
                            </tr>
                          @endforeach
            ...
            $(function() {
              $('.status').change(function() {
                ...
                $.ajax({
                  ...
                  url: "{{ route('status.product.newarrivals') }}",
                  type: "POST",
                  dataType: 'json',
