@extends('admin.layouts.admin', ['pageTitle' => 'UPDATE TRENDING PRODUCT DETAILS'])
  ...
  <div class="col-md-12 d-flex align-items-stretch grid-margin">
    <div class="row flex-grow">
      ...
      <div class="col-12 stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">UPDATE TRENDING PRODUCT DETAILS</h4>
            {{-- <p class="card-description">
              Horizontal form layout
            </p> --}}
            <form class="forms-sample" action="{{route('update.product.trending',$id)}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
             ...
             {{--  <div class="form-group row">
              ...
              <a href="{{route('trendingProductIndex')}}"   class="btn btn-light">Cancel</a>
            </form>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  $("body").on("click",".minusImage", function(){
     ...
     $.ajax({
                'url' : "{{route('removeproductimage.trending','')}}/"+imageID[1],
                'type': 'GET',
                'dataType' : 'JSON',
