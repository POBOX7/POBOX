      ...
      <div class="col-12 stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" action="{{route('update.blog',$id)}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="blog_title" name="blog_title" placeholder="Title" value="{{$blogDetail->blog_title}}" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="author" name="author" value="{{$blogDetail->author}}" placeholder="name" required>
              ...
              <!-- <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="slug" name="slug" value="{{$blogDetail->slug}}" placeholder="slug" required>
                  @if ($errors->has('slug'))
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <div id="datepicker-popup" class="input-group date datepicker">
                    <input type="text" class="form-control" name="blog_date" required value="{{$newDate}}">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <textarea id='editor' name="blog_description">{{$blogDetail->blog_description}}</textarea>
