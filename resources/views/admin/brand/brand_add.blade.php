  ...
  <div class="col-md-12 d-flex align-items-stretch grid-margin">
    <div class="row flex-grow">
      ...
      <div class="col-12 stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">ADD NEW BRANDS DETAILS</h4>
            ...
            <form class="forms-sample" action="{{route('store.brand')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="name" name="name" placeholder="Name" maxlength="15" required onkeyup="countChar(this)"> 
