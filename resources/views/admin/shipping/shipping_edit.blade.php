  ...
  <div class="col-md-12 d-flex align-items-stretch grid-margin">
    <div class="row flex-grow">
      ...
      <div class="col-12 stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">UPDATE SHIPPING DETAILS</h4>
            {{-- <p class="card-description">
              Horizontal form layout
            </p> --}}
            <form class="forms-sample" action="{{route('update.shipping',$id)}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
             <div class="form-group row">
                <label for="from_km" class="col-sm-3 col-form-label">From Km</label>
                <div class="col-sm-3">
                  <input type='text' class="form-control" onKeyPress = 'return isNumberKey(event)' id="from_km" name="from_km" value="{{$shippingDetail->from_km}}" onkeyup="fromKmCountChar(this)" maxlength="5"  required/>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <input type='text' class="form-control" onKeyPress = 'return isNumberKey(event)' id="to_km" name="to_km" value="{{$shippingDetail->to_km}}" onkeyup="toKmCountChar(this)" maxlength="5"  required/>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <input type='text' class="form-control" onKeyPress = 'return isNumberKey(event)' id="rate" name="rate" value="{{$shippingDetail->rate}}" onkeyup="rateCountChar(this)" maxlength="5"  required/>
