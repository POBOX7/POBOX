...
margin-top: -4px!important;
   ...
   width: 50%;
                                            ...
                                            <div class="product-desc">
                                                <p style="line-break: anywhere;font-size: 16px!important">{{$valueProductDetailData['short_description']}}</p>
                                          ...
                                          <!-- End .product-single-filter -->
                                         <div>
                                           <label style="color: black;float: left;padding-right: 5px;">Brand: </label>  <p style="font-size: 17px!important;
    padding-top: 3px!important;">{{$brandName->name}}</p>
                                         </div>
                                         <div>
                                           <label style="color: black;float: left;padding-right: 5px;">Categories:</label>  <p style="font-size: 17px!important;
    padding-top: 3px!important;">{{$CategoryName->name}}</p>
                                         </div>
