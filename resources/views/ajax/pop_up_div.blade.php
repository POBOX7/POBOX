                                          ...
                                          <div class="col-lg-6 col-md-6">
                                             <div class="product-single-details">
                                                ...
                                                <div class="product-filters-container">
                                                    ...
                                                    <label>Size:</label>
                                                    <div class="new_arrival_pop_size_filter" id="new_arrival_pop_size_filter">
                                                ...
                                                <div class="product-filters-container">
                                                   <div class="product-single-filter" data-product-id="">
                                                      ...
                                                      <div class="product_pop_color_filter" id="product_pop_color_filter">
                                                          @php 
                                                          $colorsData =  App\Colors::getColorFromSKU($valueNewArrivalProductData['sku']) ;
                                                          @endphp   
                                                ...
                                                <div class="product-action">
                                                   <div id="myDiv" style="width: 100%;">
                                                      <div class="quantity-container">
                                                         ...
                                                         <div class="{{$valueNewArrivalProductData['id']}}" id="{{$valueNewArrivalProductData['id']}}"  onclick="increaseValue(this.id)" 
                                                         data-product-id="{{$valueNewArrivalProductData['id']}}"
                                                         data-product-price="{{$valueNewArrivalProductData['price']}}"
